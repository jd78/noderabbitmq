...
module.exports = {
	initialize: async conf => {
		if (conf) {
            ...
            if (conf.infoLog)
                configuration.infoLog = conf.infoLog
            ...
            if(conf.exclusiveConsumer)
                configuration.exclusiveConsumer = conf.exclusiveConsumer
            
            if(conf.passiveConsumerRertyConnectInMilliseconds)
                configuration.passiveConsumerRertyConnectInMilliseconds = conf.passiveConsumerRertyConnectInMilliseconds
